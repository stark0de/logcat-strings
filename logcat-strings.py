...
commonstrings=["pwd", "password", "passcode", "verif", "hash", "key", "API key", "api","code", "2FA", "token","passwd", "pin", "pincode", "@", "secret", "private", "serial", "logon", "login", "logged", "session", "creds", "credential", "user", "IP", "mail", "nick"]
lines=[]
while True:
